...
function Hero() {
  return (
    <section className='relative min-h-screen flex items-center overflow-hidden sm:pt-10 pt-20'>
              ...
              <div className='space-y-6'>
                ...
                <div className='inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary/10 to-primary/5 rounded-full border border-primary/20 backdrop-blur-sm'>
                  <div className='h-2 w-2 bg-primary rounded-full animate-pulse'></div>
                    <span className='text-sm font-medium text-primary'>AI Powered Dental AI Assistant</span>
                </div>
                ...
                <div className='flex flex-col sm:flex-row gap-4'>
                  ...
                  <SignUpButton mode='modal'>
                    <Button size={'lg'} variant={"outline"}>
                      <NotepadText className='size-5 mr-2'/>
                      Book Appointment
                    </Button>
                  </SignUpButton>
                </div>
                ...
                {/* USER TESTIMONIALS */}
              <div className="pt-8 ">
                <div className="flex items-center sm:gap-0.5 gap-6 ">
                  {/* USER AVATARS */}
                  <div className="flex -space-x-3 sm:mr-10">
                    <Image
