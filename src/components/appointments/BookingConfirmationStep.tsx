...
function BookingConfirmationStep({selectedType,onBack,onConfirm,onModify,selectedDate,selectedDentistId,selectedTime,isBooking}:BookingConfirmationStepProps) {
